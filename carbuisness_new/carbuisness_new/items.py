...
class XiaoZhuItem(scrapy.Item):
    ...
    price = scrapy.Field()
    commonly_low = scrapy.Field()
    commonly_middle = scrapy.Field()
    commonly_high = scrapy.Field()
    good_low = scrapy.Field()
    good_middle = scrapy.Field()
    good_high = scrapy.Field()
    excellent_low = scrapy.Field()
    excellent_middle = scrapy.Field()
    excellent_high = scrapy.Field()
    output = scrapy.Field()
    model = scrapy.Field()
    year = scrapy.Field()
