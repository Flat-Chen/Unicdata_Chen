...
from http_proxy import TUNNEL_FAIL
...
def parse_command_line(description):
    ...
    parser.add_argument('-H', metavar='host', type=str, default='127.0.0.1',
                        help='IP or hostname for http_proxy (default "127.0.0.1")', )
    parser.add_argument('-P', metavar='port', type=int, default=18080, help='port for http_proxy (default 18080)')
    parser.add_argument('-sh', metavar='socks_host', type=str, default='127.0.0.1',
                        help='socks_proxy IP or hostname (default "127.0.0.1")')
