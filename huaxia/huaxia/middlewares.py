...
class HuaxiaProxyMiddleware(object):
    def __init__(self):
        self.count = 0
    ...
    def process_request(self, request, spider):
        if spider.name in ['update_hx2car_carType', 'huaxia_car', 'huaxia_guzhi', 'jzg_40city',
                           'che300_price_daily_sh_city',
...
class HuaxiaUserAgentMiddleware(UserAgentMiddleware):
    def process_request(self, request, spider):
...
class h2xUserAgentMiddleware(UserAgentMiddleware):
    def process_request(self, request, spider):
        pass

    class HuaxiaSpiderMiddleware(object):
...
class HuaxiaDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
