...
def main():
    ...
    while 1:
        ...
        try:
            ...
            cookie4 = {
                '_che300': 'Msx5nKbGGGRWahfX3eFwEu7GcTwd8bmsZ2oirflk6i1wqQfOmM81PLLnReraDUfm3rbXoU9lwEtmlpj%2FACC6yzirPUI1suGZtMz%2BzyIoAJq6wEqlgHK%2B75wKHKdDegSWeZsZzkZX%2BgBVJpmIYnEfrQA%2BOAJMm2mNEPhHek3xpiAvwFiit0NA8L%2FCTME0LWIJ57GsD2fUgthKB7%2F1utU5UszIUn%2FJSUizWLh%2BypO9%2Fk7FUdCyWqGxiEVlE86z1l4dxXgADzOqEQfE47xYzHjnyn25Z1uyAL8SzrLzhPXxvrkR63RhYyTbH2cWASlHNg5avheH9THRZE9DgNmqtIz%2F2Y2DCsFFRMW2T65XkrTE%2BQnUHdNKhweczTb5UpWdWoLFN5fM5ClCgvYH%2BMjwsNqfD4Xyxjrxej1CzjKslle1EE6oRmdg8w7Xn%2BT0FRrttnAlQoxu0X8VKwoNxBCYL91CLQ%3D%3D264c3be71f5a81a335362f28e97e60002c615539',
                'ci_session': '722ee523097e05c21c4398f3ee6de60bd752d68e'}

            browser.get(url)
            for key in cookie4.keys():
                browser.add_cookie(cookie_dict={'name': key, 'value': cookie4[key]})
